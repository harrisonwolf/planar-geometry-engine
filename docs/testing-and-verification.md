...
The project currently uses one TDD-style regression runner plus two packaging smoke tests.
...
`testing/tdd_suite.cc` currently runs these suites:
...
The runner prints assertion counts and reports suite/name/message triples for failures.
