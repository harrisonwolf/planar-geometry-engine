//implementation file for new polygon class
//TODO: Actually can just leave the new filenames and call the class Polygon, since
//whichever file I include in the Makefile will be the one it gets the Polygon class defn from
